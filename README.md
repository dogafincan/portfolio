...
- Treat the mesh chrome as app identity: safe areas, theme color, manifest
  ...
  the active mesh color in both light and dark mode. Static manifest colors stay
  tied to the light-mode chrome unless a separate install-color decision changes
  them. Dark meshes should have visible blobs and stay distinguishable from
  sibling apps.
