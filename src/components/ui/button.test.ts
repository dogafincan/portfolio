...
describe("button variants", () => {
  ...
  it("keeps ordinary secondary actions on the neutral outline hierarchy", () => {
    ...
    expect(outline).toContain("hover:bg-control-hover");
    expect(outline).toContain("hover:text-foreground");
    expect(outline).toContain("active:bg-control-active");
    expect(outline).toContain("aria-expanded:bg-control-hover");
    expect(outline).toContain("aria-expanded:text-foreground");
    expect(outline).toContain("aria-pressed:bg-control-active");
    expect(outline).not.toContain("dark:hover:bg-input/30");
  ...
  it("provides filled semantic actions and alert-matched muted tones", () => {
    ...
    expect(infoMuted).toContain("border-info-border");
    expect(infoMuted).toContain("bg-info");
    expect(infoMuted).toContain("text-info-foreground");
    expect(infoMuted).toContain("hover:bg-info-hover");
    expect(infoMuted).toContain("active:bg-info-active");
    ...
    expect(warningMuted).toContain("border-warning-border");
    ...
    expect(destructiveMuted).toContain("border-destructive-border");
