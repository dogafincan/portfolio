...
describe("RootDocument head", () => {
  it("declares app manifest, shared logo assets, and mobile chrome colors", () => {
    ...
    expect(source).toContain('const APP_CHROME_COLOR = "#dbe7ff";');
    expect(source).toContain('const APP_CHROME_COLOR_DARK = "#5068bd";');
    ...
    expect(manifest).toContain('"theme_color": "#dbe7ff"');
    expect(manifest).toContain('"background_color": "#dbe7ff"');
