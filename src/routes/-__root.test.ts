...
describe("RootDocument head", () => {
  it("declares app manifest, shared logo assets, and mobile chrome colors", () => {
    ...
    expect(source).toContain('const APP_CHROME_COLOR = "#43C3EC";');
    expect(source).toContain('const APP_CHROME_COLOR_DARK = "#43C3EC";');
    ...
    expect(manifest).toContain('"theme_color": "#43C3EC"');
    expect(manifest).toContain('"background_color": "#43C3EC"');
