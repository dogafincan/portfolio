/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=/dev/null` (hash: 6acdf2fcd81f8578efd312fd0d2e5b5c)
// Runtime types generated with workerd@1.20260801.1 2026-05-22 nodejs_compat
interface __BaseEnv_Env {
	PORTFOLIO_PUBLIC_CLIENT_LIMITER: RateLimit;
	PORTFOLIO_PUBLIC_LOCATION_LIMITER: RateLimit;
	PORTFOLIO_PAID_CLIENT_LIMITER: RateLimit;
	PORTFOLIO_PAID_LOCATION_LIMITER: RateLimit;
	ASSETS: Fetcher;
	REGISTRY_PUBLIC_GATEWAY: Fetcher /* doji-registry */;
}
